...
export default function MistakeAnalytics() {
  ...
  const generateInsights = () => {
    ...
    const mostFrequent = analytics[0]; // Already sorted by frequency
  ...
  const generateRecommendations = () => {
    ...
    // Priority 1: Recent and frequent
    ...
    // Priority 2: High financial impact
  ...
  const insights = analytics.length > 0 ? generateInsights() : [];
  const recommendations = analytics.length > 0 ? generateRecommendations() : [];

  return (
    <div className="space-y-6">
      {/* Insights and Recommendations - Top Priority */}
